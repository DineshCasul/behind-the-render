...
export const glossary: GlossaryEntry[] = [
  ...
  { term: "CLS", match: ["CLS"], meaning: "Cumulative Layout Shift. A score for how much things jump around on the page while it loads." },
  ...
  { term: "Percentile", match: ["75th percentile"], meaning: "A way to summarize many measurements. The 75th percentile is the value that 75 out of 100 visits were as good as or better than." },
