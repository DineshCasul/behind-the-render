...
export const glossary: GlossaryEntry[] = [
  ...
  { term: "Compositing", match: ["compositing", "composite", "compositor"], meaning: "Combining separately painted layers into the final picture, usually done by the graphics card, so it's very fast." },
  ...
  { term: "Placeholder", match: ["placeholder", "placeholders", "skeleton"], meaning: "A stand-in (often a grey shape) shown while the real content is still loading." },
  ...
  { term: "Main thread", match: ["main thread"], meaning: "The one worker inside the browser that runs your JavaScript and also lays out and draws the page. While it is busy, the page can't react to you." },
  { term: "Long task", match: ["long task", "long tasks"], meaning: "A piece of work that keeps the main thread busy for more than 50 milliseconds, long enough that a tap can feel ignored." },
  { term: "Event loop", match: ["event loop"], meaning: "The browser's routine of picking the next waiting task, running it to the end, then taking the next one." },
  { term: "Web Worker", match: ["Web Worker", "Web Workers"], meaning: "A background thread you can hand heavy calculations to, so the main thread stays free. It can't touch the page's elements directly." },
  { term: "LCP", match: ["LCP"], meaning: "Largest Contentful Paint. How long until the biggest thing in view (often a heading or image) appears." },
  { term: "INP", match: ["INP"], meaning: "Interaction to Next Paint. How long the page takes to visibly respond after you tap, click or type." },
  { term: "CLS", match: ["CLS"], meaning: "Cumulative Layout Shift. A score for how much things jump around on the page, mostly while it loads." },
  { term: "TTFB", match: ["TTFB", "time to first byte"], meaning: "Time to First Byte. How long you wait before the first piece of the response starts arriving." },
  { term: "Percentile", match: ["75th percentile"], meaning: "A way to summarize many measurements. The 75th percentile is the value that 75 out of 100 visits were at or below. For load times, that means 75 out of 100 visits were that fast or faster." },
  { term: "Lab data", match: ["lab data"], meaning: "Measurements from a controlled test run on one device and network, good for debugging." },
  { term: "Field data", match: ["field data"], meaning: "Measurements collected from real visitors on their own devices, which shows what people actually experience." },
  { term: "Canonical URL", match: ["canonical"], meaning: "The one address you tell search engines is the main version of a page, when it can be reached in several ways." },
];
