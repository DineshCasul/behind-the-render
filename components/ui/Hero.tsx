...
export function Hero() {
  return (
    <section className="relative mx-2 flex min-h-[50vh] flex-col items-center justify-center overflow-hidden rounded-2xl border border-[var(--color-border)] px-6 pb-16 text-center sm:mx-6 sm:min-h-[56vh]">
      <AmbientParticles />
      <HudCorners />
